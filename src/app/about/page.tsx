  ...
  return (
    <>
      ...
      <section className="max-w-4xl mx-auto px-6 py-20">
        <h2 className="text-2xl font-extrabold text-gray-900 mb-10 text-center">What makes PlanitPlease different</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            },
            {
              ...
              desc: "You pick what matters most whether that is grades, rest, networking, or fitness. PlanitPlease builds your plan around that.",
            },
            {
              icon: "⚡",
      ...
      <section className="bg-emerald-700 text-white py-20 text-center">
        <div className="max-w-2xl mx-auto px-6">
          ...
          <p className="text-emerald-100 mb-8">Join the waitlist and be first in line when PlanitPlease launches.</p>
          <Link
            href="/#waitlist"
